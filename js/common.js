...
*/
    ...
    // если готовность букета с 7 до 10, то мы разрешаем выставлять рамки заказа в пределах 1 часа от времени готовности,
    // и остальные проверки кроме, 2,5 часов оствляем
    if (tt_ready >= 7 && tt_ready <= 10){
    ...
    if ((set_date == tomarrow && t_now > 21 && tt_end < 12) || (set_date == today && t_now < 9 && tt_end < 12 ) ){
        errors += '<li>Заказ с доставкой в период с 7:00 до 12:00 можно оставить не раньше 09:00 и не позднее 21:00.</li><br/>';
        no_error = false;
    }
    // if ((set_date == tomarrow && t_now > 21 && tt_end < 11) || (set_date == today && t_now < 11 && tt_end < 11 ) ){
    //     errors += '<li>Заказ с доставкой в период с 7:00 до 11:00 можно оставить не позднее 21:00.</li><br/>';
    //     no_error = false;
    // }
